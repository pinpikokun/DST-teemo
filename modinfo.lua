...
configuration_options = {
    ...
    -- サモナースペル: フラッシュ
    {
        ...
        hover = "Flash cooldown in seconds / フラッシュのクールダウン（秒）",
        options = {
    ...
    },
    {
        name = "flash_range",
        label = "Flash Range",
        hover = "Maximum teleport distance / フラッシュの最大ワープ距離",
        options = {
    ...
    -- サモナースペル: イグナイト
    {
        ...
        hover = "Ignite cooldown in seconds / イグナイトのクールダウン（秒）",
        options = {
            {description = "30s",  data = 30},
            {description = "60s",  data = 60},
            {description = "120s", data = 120},
    ...
    },
    {
        name = "ignite_range",
        label = "Ignite Range",
        hover = "AoE radius of Ignite / イグナイトの効果範囲（半径）",
        options = {
            {description = "3",  data = 3},
            {description = "4",  data = 4},
            {description = "5",  data = 5},
